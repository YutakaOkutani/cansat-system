...
PHASE6_RAM_SPEED = GRASS_MIN_MOTOR_SPEED
...
# Phase5は画面内の赤占有率に応じて段階的に減速する。停止判定は
# close_reached_ok のみに限定し、通常の接近中は芝生でストールしない
# 45%以上を維持する。
PHASE5_BASE_SPEED = 65
PHASE5_MID_SPEED = 55
PHASE5_NEAR_SPEED = GRASS_MIN_MOTOR_SPEED
