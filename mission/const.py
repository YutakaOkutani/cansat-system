...
PHASE4_CANDIDATE_OUTER_SPEED = 75
PHASE4_CANDIDATE_INNER_SPEED = GRASS_MIN_MOTOR_SPEED
PHASE4_REACQUIRE_TURN_SEC = 0.80
PHASE4_TRACK_ROTATE_GAIN = 100
PHASE4_TRACK_ROTATE_CLAMP = 30
...
# 低FPSでの過補正を避け、画面端でも両輪前進の穏やかな弧で戻す。
CAMERA_EDGE_TURN_ERROR = 0.20
CAMERA_EDGE_TURN_RELEASE_ERROR = 0.12
CAMERA_EDGE_TURN_SPEED = 85
CAMERA_EDGE_TURN_INNER_SPEED = 65
...
PHASE4_MOTOR_RAMP_TIME = 0.20
PHASE5_MOTOR_RAMP_TIME = 0.20
# 監視は高速のまま、走行指令の更新は新しい画像ごとに制限する。
PHASE45_MOTOR_LOOP_INTERVAL = 0.02
CAMERA_CONTROL_INITIAL_FRAME_SEC = 0.55
CAMERA_CONTROL_MIN_HOLD_SEC = 0.20
CAMERA_CONTROL_MAX_HOLD_SEC = 0.65
CAMERA_CONTROL_HOLD_FACTOR = 1.15
CAMERA_CONTROL_PERIOD_ALPHA = 0.30
BASE_SPEED = 100
...
CONE_CLOSE_TRACK_CONFIRM_FRAMES = 3
CONE_CLOSE_TRACK_MAX_SEC = 6.0
CONE_CLOSE_TRACK_DISTANCE_CM = 15.0
CONE_CLOSE_TRACK_MAX_TURN_DEG = 10.0
CONE_CLOSE_TRACK_MIN_OCCUPANCY = 0.40
CONE_CLOSE_TRACK_MAX_HUE_CHANGE = 0.12
CONE_CLOSE_TRACK_MAX_SV_CHANGE = 0.25
CONE_CLOSE_TRACK_MIN_HUE = 0.60
CONE_CLOSE_TRACK_MIN_SV = 0.34
CONE_CLOSE_TRACK_MIN_ROI_SUPPORT = 0.10
CONE_CLOSE_TRACK_WIDTH_FRAC = 0.86
CONE_CLOSE_TRACK_MIN_EDGES = 3
CONE_CLOSE_TRACK_BEARING_TOLERANCE_DEG = 15.0
CONE_CLOSE_TRACK_OCCUPANCY_RATIO_MIN = 0.4
CONE_CLOSE_TRACK_OCCUPANCY_RATIO_MAX = 2.5
